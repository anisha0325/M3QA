...
for epoch in tqdm(range(EPOCHS)):  # Number of epochs
    ...
    log_epoch_info_text_img(file_path, epoch, train_loss, valid_loss, valid_accuracy_sent, valid_accuracy_img, valid_f1_sent, valid_f1_img, test_sent_accuracy, test_sent_f1, test_img_accuracy, test_img_f1)